Shader "VFX_Shader/ATK/fxs_atklit_Trail_01_b" {
	Properties {
		_Animation_Dissolve ("Animation Dissolve", Range(0, 1)) = 0
		[HDR] _Center_Color ("Center Color", Vector) = (1,1,1,0)
		...
		_Main_Wave ("Main Wave", Range(0, 1)) = 1
		_Main_Wave_Speed ("Main Wave Speed", Float) = 1
		_Main_Wave_Frequency ("Main Wave Frequency", Float) = 12
		_Main_Scroll_Speed ("Main Scroll Speed", Float) = 1
		_Main_Wave_Scale ("Main Wave Scale", Range(1, 10)) = 5
