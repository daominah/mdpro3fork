Shader "VFX_Shader/fxs_AlphaStep_TC_01_b" {
	Properties {
		...
		_Texture_Cgannel_Selection ("Texture Cgannel Selection", Vector) = (1,0,0,0)
		...
		_MASK_Cgannel_Selection ("MASK Cgannel Selection", Vector) = (0,0,0,1)
