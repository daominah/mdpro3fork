Shader "VFX_Shader/ATK/fxs_atkfie_Trail_01_b" {
	Properties {
		...
		[HDR] _Color_03 ("Color 03", Vector) = (1,0.205496,0,0)
		...
		_Sub_Wave ("Sub Wave", Range(0, 1)) = 0.5
		_Sub_Wave_Speed ("Sub Wave Speed", Float) = 10
		_Sub_Wave_Frequency ("Sub Wave Frequency", Float) = 18
		_Sub_Scroll_Speed ("Sub Scroll Speed", Float) = 1
		_Sub_Wave_Scale ("Sub Wave Scale", Range(1, 10)) = 3
