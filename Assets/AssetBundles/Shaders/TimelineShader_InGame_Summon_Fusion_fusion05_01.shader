Shader "TimelineShader/InGame/Summon/Fusion/fusion05_01" {
	Properties {
		...
		_ColorE ("ColorE", Vector) = (0.7000312,0.7264151,0.1987362,0.5019608)
		[NoScaleOffset] _CardFrameE ("CardFrameE", 2D) = "white" {}
		_Scale ("Scale", Range(1, 10)) = 1
		_Rotate ("Rotate", Float) = 0
		_TwistStrength ("TwistStrength", Float) = 0
		_CardAOffset ("CardAOffset", Vector) = (0,-0.87,0,0)
		_CardBOffset ("CardBOffset", Vector) = (1.35,-0.25,0,0)
		_CardCOffset ("CardCOffset", Vector) = (0.9,0.87,0,0)
		_CardDOffset ("CardDOffset", Vector) = (-0.9,0.87,0,0)
		_CardEOffset ("CardEOffset", Vector) = (-1.3,-0.25,0,0)
