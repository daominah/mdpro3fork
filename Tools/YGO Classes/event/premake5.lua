project "event"
    ...
    includedirs { ".", "include",  "compat", "windows" }
    ...
    files {"event_tagging.c", "http.c", "evdns.c", "evrpc.c", "win32select.c", "evthread_win32.c", "buffer_iocp.c", "event_iocp.c", "bufferevent_async.c"}
